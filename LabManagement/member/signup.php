	...
	<div class="panel">
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-12 col-xs-12 col-md-offset-4">
				<!-- Student Signup Form snippet -->
<form class="frm_student_sign">
    <h4 class="">Sign up - Student</h4>
    <hr>
    <div class="form-group">
        <label>School ID Number</label>
        <input type="text" name="sid_number" id="sid_number" class="form-control" placeholder="e.g. 21-1-1-0221" required autocomplete="off" maxlength="11">
    </div>
