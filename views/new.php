...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 col-md-2 sidebar">
	...
	<ul class="nav menu">
		...
		<li><a href="user"><svg class="glyph stroked female user"><use xlink:href="#stroked-female-user"/></svg>User</a></li>
		<?php 
			}
				...
				<div class="panel panel-primary custom-panel">
					...
					<div class="panel-body">
						<form class="frm_borrow">
							...
							<div class="form-group">
								<label>Select Items (maximum of 5 items)</label>
							...
							<div class="form-group">
								<label>Chemicals (maximum of 5)</label>
								<select class="form-control input-lg borrowchemical" name="borrowchemical[]" multiple="multiple" style="width: 100%">
									<option></option>
								</select>
							</div>

							<!-- ✅ Added chemical quantity input container -->
							<div id="chemical-quantity-container" class="col-md-12 mt-2"></div>
...
// ✅ Auto-generate input fields when chemicals are selected
$('.borrowchemical').on('change', function() {
	...
	selected.each(function() {
		let chemName = $(this).text();
		let chemValue = $(this).val();
